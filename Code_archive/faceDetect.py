...
face_cascade = cv2.CascadeClassifier('D:\pycharm\envs\pystudy\Lib\site-packages\cv2\data\haarcascade_frontalface_alt2.xml')
eye_cascade = cv2.CascadeClassifier('D:\pycharm\envs\pystudy\Lib\site-packages\cv2\data\haarcascade_eye.xml')

dirs = [r'D:\pythonproject\DrowsyDriverDetection-master\pic\normal']
def detectFaces():
    pos = 0
    for dir in dirs:
        cnt = 0
            ...
            if filename.endswith('.jpg'):
               ...
               # gray = cv2.resize(gray, (0, 0), fx=0.5, fy=0.5)
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite('D:\pythonproject\DrowsyDriverDetection-master\pic\gray\IMG_'+str(pos)+'.png', roi_gray)
                    pos+=1
